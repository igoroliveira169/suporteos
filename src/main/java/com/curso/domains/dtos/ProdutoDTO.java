...
public class ProdutoDTO {
    ...
    @NotBlank(message = "O campo código de barras não pode estar vazio!")
    ...
    public @NotNull(message = "O campo código de barras não pode ser nulo!") @NotBlank(message = "O campo código de barras não pode estar vazio!") String getCodigoBarra() {
        return codigoBarra;
    }

    public void setCodigoBarra(@NotNull(message = "O campo código de barras não pode ser nulo!") @NotBlank(message = "O campo código de barras não pode estar vazio!") String codigoBarra) {
